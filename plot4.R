  ...
  plot(household_power_data$dateTime,household_power_data$Voltage,type="l",
     xlab = "datetime",ylab="Voltage")

  plot(household_power_data$dateTime,y=household_power_data$Sub_metering_1 ,type="l",xlab="",ylab="Energy sub metering")
  ...
  legend("topright" ,lty= "solid", col= c("black","red","blue"),
         legend= c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),bty=
           "n")

  plot(household_power_data$dateTime,household_power_data$Global_reactive_power,type="l",
